...
#ifndef RETIREMENTCALCU_SWIFT_H
#define RETIREMENTCALCU_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RetirementCalcu",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15RetirementCalcu11AppDelegate")
@interface AppDelegate : UIResponder <MSACCrashesDelegate, UIApplicationDelegate>
...
- (BOOL)crashes:(MSACCrashes * _Nonnull)crashes shouldProcessErrorReport:(MSACErrorReport * _Nonnull)errorReport SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC15RetirementCalcu13SceneDelegate")
